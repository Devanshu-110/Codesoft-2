...
class GUI():
    def __init__(self,master):
        ...
        self.user = Label(text="Enter User Name: ", font='times 15 bold', bg='#FF8000', fg='skyblue')
        ...
        self.length = Label(text="Enter Password Length: ", font='times 15 bold', bg='#FF8000', fg='skyblue')
        ...
        self.generated_password = Label(text="Generated Password: ", font='times 15 bold', bg='#FF8000', fg='skyblue')
